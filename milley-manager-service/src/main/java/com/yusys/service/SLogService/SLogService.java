...
public  class SLogService implements ISLogService{
	...
	//新增日志配置信息
	@Override
	public Map<String,String> savelogConfig(HttpServletRequest req, String userId)
    {
		Map<String,String> retMap = new HashMap<String,String>();
        String must[] = {
            "loginlog_state", "loginlog_timelimit", "optlog_state", "optlog_timelimit", "errorlog_state", "errorlog_timelimit"
        };
        ...
        try
        {
            ...
            if(redisCache != null)
                redisCache.put("LOG", JsonUtils.beanToJson(param));
            logger.info((new StringBuilder("update log config:")).append(DateTimeUtils.getFormatCurrentTime()).toString());
