...
public class SLogController extends BaseController {
	...
	public void queryLoginLog(HttpServletRequest req,HttpServletResponse res){
		try{
			writeUTFJson(res,JsonUtils.beanToJson(logService.queryLoginLog(req,getUserId(req))));
		}catch(Exception e){
			e.printStackTrace();
		}
	}
	...
	public void queryOrgTreeList(HttpServletRequest req,HttpServletResponse res){
		try{
			writeUTFJson(res,JsonUtils.beanToJson(logService.queryOperaLog(req,getUserId(req))));
		}catch(Exception e){
			e.printStackTrace();
		}
	}
	...
	public void savelogConfig(HttpServletRequest req, HttpServletResponse res)
    {
        try
        {
            writeUTFJson(res, JsonUtils.beanToJson(logService.savelogConfig(req, getUserId(req))));
        }
        catch(Exception e)
        {
            e.printStackTrace();
