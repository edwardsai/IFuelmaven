...
public class SAuthorizeController extends BaseController {
	...
	@Resource
	private ISAuthorizeService iSAuthorizeService;
	...
	public void writeUTFJson(HttpServletResponse res,String json){
		...
		public void SaveSdic(HttpServletRequest req,HttpServletResponse res)	{
			writeUTFJson(res,JsonUtils.beanToJson(iSAuthorizeService.save(req,getUserId(req))));		
		}
		//删除类别
		@RequestMapping("/delete")
		public void DeleteSdic(HttpServletRequest req,HttpServletResponse res)	{
			writeUTFJson(res,JsonUtils.beanToJson(iSAuthorizeService.delete(req,getUserId(req))));
		}
		//修改类别
		@RequestMapping("/update")
		public void UpdateSdic(HttpServletRequest req,HttpServletResponse res)	{
			writeUTFJson(res,JsonUtils.beanToJson(iSAuthorizeService.update(req,getUserId(req))));		
		}
		//根据用户ID  查询授权信息
		@RequestMapping("/findById")		
		public void FindById(HttpServletRequest req,HttpServletResponse res)	{
			writeUTFJson(res,JsonUtils.beanToJson(iSAuthorizeService.FindById(req,getUserId(req))));
		}	
		//多条件查询所有类别信息
		@RequestMapping("/findAll")
		public void findAllSDic(HttpServletRequest req,HttpServletResponse res)	{
			writeUTFJson(res,JsonUtils.beanToJson(iSAuthorizeService.findAll(req,getUserId(req))));
		}
