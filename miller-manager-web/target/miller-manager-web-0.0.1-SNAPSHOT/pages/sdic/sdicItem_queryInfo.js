function initSdicItem_config(id) {
	// 初始化
	
	initSdicItem_queryInfoTable(id);
...
//	$("#dic_is_default").select2();
	...
	initSelect($("#dic_is_default"),{value:"ITEM_CODE",text:"ITEM_NAME"},{dic_code:"S_DIC_IS_LOCALE"});	
	...
	$("#update_item").click(function(){
        ...
        $.ajax({
	           ...
	           success:function(result){
	    	      ...
	    	      initSelect($("#dic_is_update_default"),{value:"ITEM_CODE",text:"ITEM_NAME"},{dic_code:"S_DIC_IS_LOCALE"},result.list[0].is_default);
...
function item_return(){
	$("#item_queryInfo_return").click(function(){
		newOpenDicInfoTab("sdic_manager","字典数据管理","pages/sdic/sdic_queryInfo.html", function(){});
	});
}

function initSdicItem_queryInfoTable(id){
	// 字典项页面加载
	var dic_code = $.map(id, function(row) {
		return (row.DIC_CODE);
	});
