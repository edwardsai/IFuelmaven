...
(function(c) {
                ...
                if (e[0]) {
                    if (e[0] == "*") {
                        ...
                        c("#" + j.queueID).find(".uploadify-queue-item").each(function() {
                            ...
                            c(this).find(".data").removeClass("data").html(" - 已清空");
                        ...
                        for (var m = 0; m < e.length; m++) {
                            i.cancelUpload(e[m]);
                            c("#" + e[m]).find(".data").removeClass("data").html(" - 已清空");
                    ...
                    $item.find(".data").removeClass("data").html(" - 已清空");
    ...
    var a = {
        onDialogOpen: function() {
            var d = this.settings;
            this.queueData.errorMsg = "您选择的文件:";
        ...
        onSelect: function(h) {
            ...
            if (i.itemTemplate == false) {
                i.itemTemplate = '<div id="${fileID}" class="uploadify-queue-item">					<div class="cancel" title="取消附件">						<a href="javascript:$(\'#${instanceID}\').uploadify(\'cancel\', \'${fileID}\')">X</a>					</div>					<span class="fileName">${fileName} (${fileSize})</span><span class="data"></span>					<div class="uploadify-progress">						<div class="uploadify-progress-bar"><!--Progress Bar--></div>					</div>				</div>';
            }
