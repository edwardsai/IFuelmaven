...
%>
<!-- 增加分页按钮 -->
&nbsp;&nbsp;<input type="button" value="首页" onclick="report1_toPage(1)"><input type="button" value="上一页" onclick="report1_toPage(report1_getCurrPage()-1)"> 第<font id=c_page_span></font>页 共<font id="t_page_span"></font>页   <input type="button" value="下一页" onclick="report1_toPage(report1_getCurrPage()+1)"><input type="button" value="尾页" onclick="report1_toPage(report1_getTotalPage())">
