...
public interface SWorkFlowInfoDao {
	...
	//向流程表中插入一条数据
	public void addOneProcessInfo(Map<String,String> map);
	//根据选择的id删除流程表中该信息
	...
	//修改一条流程记录
	public void updateOneProcessInfo(Map<String,String> map);
	//通过流程id查询流程矩阵表中所有信息 
	public List<Map<String,Object>> queryAllMatrixById(Map<String,Object> map);
	//通过规则id查询规则表中对应信息
	...
	//修改规则表中一条数据
	public void updateOneRuleInfo(Map<String,String> map);
	//修改矩阵表中所有对应的数据-
	public void updateAllMatInfo(Map<String,String> map);
	//向审批规则表中插入一条记录
	public void addApproveRuleInfo(Map<String,String> map);
	////根据id查找矩阵下的审批路由信息
	...
	//根据流程ID修改流程状态
	public void updateProcessSateById(Map<String,String> map);
	//根据矩阵ID修改矩阵状态
	 ...
	 * @return
	 */
	public List<Map<String,String>> queryMatrixNodeInfos(Map<String,String> map);
	/**
	 * 根据ID删除 审批 流程数据 
	 * @param p_id
	 */
